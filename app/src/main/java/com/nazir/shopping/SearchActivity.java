                        ...
                        Picasso.with(getApplicationContext())
                                ...
                                .into(new Target() {
                                    ...
                                    public void onBitmapLoaded(Bitmap bitmap, Picasso.LoadedFrom from) {
                                        ...
                                        intent.putExtra(Intent.EXTRA_STREAM, Common.getlocalBitmapUri(SearchActivity.this,bitmap));
...
//                });
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int postion, boolean isLongClick) {
                        ...
                        Intent intent = new Intent(SearchActivity.this, HookahDetailActivity.class);
...
//    }
    ...
    private void loadSuggest() {
        ...
        hookahListRef.addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
